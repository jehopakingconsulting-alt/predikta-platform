...
_REC_T = {
    'fr': {
        'explore_states': 'Explorer de nouveaux Etats',
        'explore_states_desc': 'Decouvrez les analyses pour {states} — ces Etats ont des donnees riches et des tendances interessantes.',
        'first_analysis': 'Lancez votre premiere analyse',
        'first_analysis_desc': 'Allez sur /analyze, choisissez un Etat et decouvrez les predictions de nos 7 modeles ML.',
        'upgrade': 'Passez au plan PRO',
        'upgrade_desc': 'Debloquez plus d\'analyses, d\'alertes et de fonctionnalites avancees.',
        ...
        'try_copilot_desc': 'Posez des questions sur vos predictions, tendances et strategies a notre assistant IA.',
    },
    'en': {
    ...
    'es': {
        ...
        'explore_states_desc': 'Descubre analisis para {states} — estos estados tienen datos ricos y tendencias interesantes.',
        'first_analysis': 'Ejecuta tu primer analisis',
        'first_analysis_desc': 'Ve a /analyze, elige un estado y descubre predicciones de nuestros 7 modelos ML.',
        'upgrade': 'Actualiza a PRO',
        'upgrade_desc': 'Desbloquea mas analisis, alertas y funciones avanzadas.',
    ...
    'pt': {
        ...
        'explore_states_desc': 'Descubra analises para {states} — esses estados tem dados ricos e tendencias interessantes.',
        'first_analysis': 'Execute sua primeira analise',
        'first_analysis_desc': 'Va para /analyze, escolha um estado e descubra previsoes dos nossos 7 modelos ML.',
        'upgrade': 'Atualize para PRO',
        'upgrade_desc': 'Desbloqueie mais analises, alertas e recursos avancados.',
        'try_business': 'Experimente Business AI',
        'try_business_desc': 'Analise um projeto empresarial com nosso motor de inteligencia.',
        'try_copilot': 'Use ZYNORIQ Copilot',
        'try_copilot_desc': 'Pergunte sobre previsoes, tendencias e estrategias ao nosso assistente IA.',
    },
    'ht': {
