...
DRAW_SCHEDULE = {
    ...
    "MA": [{"tod":"Midday","time":"2:00 PM ET"},  {"tod":"Evening","time":"9:00 PM ET"}],
    "MD": [{"tod":"Midday","time":"12:28 PM ET"}, {"tod":"Evening","time":"7:56 PM ET"}],
    "ME": [{"tod":"Day","time":"1:10 PM ET"}, {"tod":"Evening","time":"6:55 PM ET"}],
    ...
    "NM": [{"tod":"Day","time":"1:00 PM MT"}, {"tod":"Evening","time":"9:30 PM MT"}],
    ...
    "RI": [{"tod":"Midday","time":"1:30 PM ET"},  {"tod":"Evening","time":"6:59 PM ET"}],
    ...
    "VT": [{"tod":"Day","time":"1:10 PM ET"}, {"tod":"Evening","time":"6:55 PM ET"}],
...
def api_debug_fetch():
    ...
    try:
        ...
        return jsonify({
            ...
            "snippet": (html[:500] if html else None),
        })
    except Exception as e:
