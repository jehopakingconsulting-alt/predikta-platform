...
const KB = {
  fr:[
    ...
    { kw:['pro','elite','abonnement','payer','prix','tarif','subscribe','forfait','plan'],
      answer:'Nos plans :\n\n🆓 FREE — $0 (prédictions + résultats de base)\n👑 PRO — $4.99/mois (ML avancé, alertes email, 12 mois)\n⭐ ELITE — $9.99/mois (API, SMS, 5 ans, tout inclus)\n\n7 jours d\'essai gratuit sur tous les plans payants !',
      quick:[{t:'Voir les Plans',href:'/pro'}] },
  ...
  en:[
    ...
    { kw:['pro','elite','subscription','price','plan','subscribe','pay'],
      answer:'Our plans:\n\n🆓 FREE — $0 (basic predictions)\n👑 PRO — $4.99/mo (advanced ML, email alerts)\n⭐ ELITE — $9.99/mo (API, SMS, 5 years data)\n\n7-day free trial on all paid plans!',
      quick:[{t:'See Plans',href:'/pro'}] },
  ...
  <div class="pf-inner">
    <div class="pf-top">
      ...
      <div>
        ...
        <a class="pf-link" href="/pro" style="color:#ffd700;font-weight:700">PRO — $4.99/mois</a>
        <a class="pf-link" href="/pro" style="color:#ff9900;font-weight:700">ELITE — $9.99/mois</a>
