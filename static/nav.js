...
const SERVICES = [
  ...
  { href:'/guide',            icon:'📘', key:'guide',       badge:'' },
  { href:'/strategies',       icon:'🏆', key:'strategies',  badge:'VIP' },
];
...
const NAV_T = {
  fr:{ home:'Accueil', analyze:'Analyser', results:'Résultats', allresults:'Tous Résultats', predictions:'Prédictions',
       ...
       worldmap:'Carte du Monde', predicktatv:'ZYNORIQ TV', community:'Communauté', pick4:'Pick 4 / Cash 4', cash5:'Cash 5 / Fantasy 5', pick5:'Pick 5 / Loto 5 Chiffres', memory:'Memory Center', founders:'Fondateurs', ambassadors:'Ambassadeurs', guide:'Guide Utilisateur', strategies:'Stratégies du Maître',
  ...
  en:{ home:'Home', analyze:'Analyze', results:'Results', allresults:'All Results', predictions:'Predictions',
       ...
       worldmap:'World Map', predicktatv:'ZYNORIQ TV', community:'Community', pick4:'Pick 4 / Cash 4', cash5:'Cash 5 / Fantasy 5', pick5:'Pick 5 / 5-Digit Lotto', memory:'Memory Center', founders:'Founders', ambassadors:'Ambassadors', guide:'User Guide', strategies:'Master Strategies',
  ...
  es:{ home:'Inicio', analyze:'Analizar', results:'Resultados', allresults:'Todos', predictions:'Predicciones',
       ...
       worldmap:'Mapa Mundial', predicktatv:'ZYNORIQ TV', community:'Comunidad', pick4:'Pick 4 / Cash 4', cash5:'Cash 5 / Fantasy 5', pick5:'Pick 5 / Lotería 5 Dígitos', memory:'Memory Center', founders:'Fundadores', ambassadors:'Embajadores', guide:'Guía del Usuario', strategies:'Estrategias del Maestro',
  ...
  pt:{ home:'Início', analyze:'Analisar', results:'Resultados', allresults:'Todos', predictions:'Previsões',
       ...
       worldmap:'Mapa Mundial', predicktatv:'ZYNORIQ TV', community:'Comunidade', pick4:'Pick 4 / Cash 4', cash5:'Cash 5 / Fantasy 5', pick5:'Pick 5 / Loto 5 Dígitos', memory:'Memory Center', founders:'Fundadores', ambassadors:'Embaixadores', guide:'Guia do Usuário', strategies:'Estratégias do Mestre',
  ...
  ht:{ home:'Akèy', analyze:'Analize', results:'Rezilta', allresults:'Tout Rezilta', predictions:'Prediksyon',
       ...
       worldmap:'Kat Mondyal', predicktatv:'ZYNORIQ TV', community:'Kominote', pick4:'Pick 4 / Cash 4', cash5:'Cash 5 / Fantasy 5', pick5:'Pick 5 / Loto 5 Chif', memory:'Memory Center', founders:'Fondatè', ambassadors:'Anbasadè', guide:'Gid Itilizatè', strategies:'Estrateji Mèt la',
...
/* Home flottant */
#pfloat-home{
  position:fixed;bottom:24px;left:56px;z-index:8001;
...
/* Nav arrows */
.pfloat-nav{
  position:fixed;bottom:28px;z-index:8001;
...
#pfloat-back{left:16px}
#pfloat-fwd{left:112px}
...
#pfloat-notif{
  position:fixed;bottom:24px;left:160px;z-index:8000;
  width:46px;height:46px;border-radius:12px;
  background:linear-gradient(135deg,#0e0e2a,#1a1a40);
